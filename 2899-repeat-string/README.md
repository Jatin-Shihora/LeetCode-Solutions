<h2><a href="https://leetcode.com/problems/repeat-string">2899. Repeat String</a></h2><h3>Easy</h3><hr><p>Write code that enhances all strings such that you can call the&nbsp;<code>string.replicate(x)</code>&nbsp;method on any string and it will return repeated string <code>x</code> times.</p>
