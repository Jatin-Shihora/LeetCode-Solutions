...
class Solution{   public:    // strings at index 0 is not used, it is to make array    // indexing simple   
...
string ten[10] = {"",       "",       "twenty ",  "thirty ", "forty ",                    "fifty ", "sixty ", "seventy ", "eighty ", "ninety "};    // n is 1- or 2-digit number    
